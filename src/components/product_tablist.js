...
// import Supplier_report from './potential_client_reports';
import Supplier_order from './product_order';
import Supplier_complaints from './product_complaints';
// import Supplier_attachments from './potential_client_attachment';
                ...
                {activeTab === 9 &&
                    ...
                    <>
                        <div>
                            <div className="flex w-full justify-between items-center mb-2">
                                <div className="product">
                                    {/* <h2 className='text-[#202E2D] text-[20px] font-medium'></h2> */}
                                    <h1 className='text-[#202E2D] text-[20px] font-medium'>Complaints</h1>
                                </div>
