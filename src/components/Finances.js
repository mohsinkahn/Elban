    ...
    <div className="p-4">
      ...
      <div className="flex space-x-2">
        ...
        <button
          ...
          className={`px-4 py-3 text-sm font-medium rounded-t-lg ${activeTab === "active2"
            ? "bg-[#355E5B1F] text-[#355E5B] border border-b-0 border-[#355E5B1A] shadow-sm"
            : "bg-[#FFFFFF] shadow-sm text-black hover:text-[355E5B]"
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-3 text-sm font-medium rounded-t-lg ${activeTab === "active3"
            ? "bg-[#355E5B1F] text-[#355E5B] border border-b-0 border-[#355E5B1A] shadow-sm"
            : "bg-[#FFFFFF] shadow-sm text-black hover:text-[355E5B]"
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-3 text-sm font-medium rounded-t-lg ${activeTab === "active4"
            ? "bg-[#355E5B1F] text-[#355E5B] border border-b-0 border-[#355E5B1A] shadow-sm"
            : "bg-[#FFFFFF] shadow-sm text-black hover:text-[355E5B]"
            }`}
        >
