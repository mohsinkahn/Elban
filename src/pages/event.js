            ...
            <div className="flex justify-between md:items-center items-baseline md:flex-row flex-col">
                <div>
                    ...
                    <p className="text-[#202E2D] font-[100] text-[14px] m-0">
                        Track meetings, trade fairs, negotiations, and key supplier interactions.
                    </p>
                </div>
                <div className="flex gap-3 md:flex-row flex-col md:mt-0 mt-3">
                    ...
                    <Link href="#" className="btn btn-filter">
                        <div className="flex items-center gap-2">
                            ...
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.66602 14.1667L9.99935 17.5M9.99935 17.5L13.3327 14.1667M9.99935 17.5V10M16.666 13.9524C17.6839 13.1117 18.3327 11.8399 18.3327 10.4167C18.3327 7.88536 16.2807 5.83333 13.7493 5.83333C13.5673 5.83333 13.3969 5.73833 13.3044 5.58145C12.2177 3.73736 10.2114 2.5 7.91602 2.5C4.46424 2.5 1.66602 5.29822 1.66602 8.75C1.66602 10.4718 2.36222 12.0309 3.48847 13.1613" stroke="#344054" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                    ...
                    <Link href="/event/add_event"  className="btn btn-primary">
