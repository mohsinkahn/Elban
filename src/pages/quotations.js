...
const tabInfo = {
  potential: {
    title: "Quotes",
    subtitle:
      "Centralized tracking of all quotations, whether supplier or client, with pricing, terms, and linked project details.",
  },
  active: {
    title: "Quotes",
    subtitle:
      ...
      <div>
        ...
        {loading ? (
          ...
          <>
            ...
            <Quotations activeTab={activeTab} setActiveTab={setActiveTab} />
          </>
        )}
      </div>
    </>
